...
public class CargoPage {
    ...
    public void setNomeCargo(String nomeCargo) {
        dsl.escreve("formulariocargo:tabview:nomecargo", nomeCargo);
    }

    //--Escrever o tipo de descricao no campo de descricaocargo
    public void setDescricaoCargo(String nomeDescricaoCaro) {
        dsl.escreve("formulariocargo:tabview:descricaocargo", nomeDescricaoCaro);
    }
...
//        }
        sincronismo.sincronismoExplicito(By.id("formulariocargo:tabview:status"));
        dsl.clicarBotao(By.xpath("//*[@id='formulariocargo:tabview:status']//span"));
        dsl.clicarBotao(By.id("formulariocargo:tabview:status_1"));
    }
...
//    //campo contido para buscar o Texto inserido a seguir
//    public void setNomeCargoBuscar(String nomeServicoBuscarBuscar) {
